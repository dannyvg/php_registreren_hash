...
<section class="clean-block clean-form h-100">
        <div class="container">
            ...
            <form action="php-code/patienten-add.php" method="post" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group mb-3"><label class="form-label">Dokter*</label><select  name="idArts" class="form-select countries order-alpha limit-pop-1000000 presel-MX group-continents group-order-na" id="roles" name="roles" required="">
                <?php 
                    include 'php-code/dropdown-patient.php';
