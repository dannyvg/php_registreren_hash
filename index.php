...
<body>
    <section class="login-clean" style="font-size: 22px;">
        <form action="php-code/authenticate.php" method="post">
            ...
            <input class="form-control" type="text" name="username" placeholder="Gebruikersnaam"></div>
            <div class="mb-3"><input class="form-control" type="password" name="password" placeholder="Wachtwoord"></div>
